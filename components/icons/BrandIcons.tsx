...
export function YouTubeIcon({ className, ...props }: BrandIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 2 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 4.4 19c1.72.46 7.6.46 7.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z" />
